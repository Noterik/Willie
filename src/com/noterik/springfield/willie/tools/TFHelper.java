...
public class TFHelper {
	...
	public static String getAudioIdFromUrl(String url) {
		int pos = url.indexOf("/audio/");
		if (pos!=-1) {
	...
	public static String getRawaudioIdFromUrl(String url) {
		int pos = url.indexOf("/rawaudio/");
		if (pos!=-1) {
